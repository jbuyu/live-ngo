  ...
  return (
    <div className="patners">
      ...
      <div className="patner-logos">
        <img src={Patlogo1} alt="patner_logo" width={130} />
        <img src={Patlogo2} alt="patner_logo" width={130} />
        <img src={Patlogo3} alt="patner_logo" width={130} />
        <img src={Patlogo4} alt="patner_logo" width={130} />
      </div>
    </div>
  );
}
